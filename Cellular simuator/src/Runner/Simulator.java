...
public class Simulator {
	...
	private void gridOranizer() {
		...
		// System.out.println(0+" "+(n-1)+" "+n+" "+((n*2)-1)+" "+(n*2)+"
		// "+((n*3)-1)+" "+(n*3)+" "+(cellGrid.getNumberOfcellLists()-1));
		...
		process4 = new ArrayList<ArrayList<atom>>(
				cellGrid.getCellLists().subList((n * 3), cellGrid.getNumberOfcellLists() - 1));
	}

	/**
	 * Multithreaded execution that divides atom operations into 4 lists, that
	 * works cuncurrent.
	 */
